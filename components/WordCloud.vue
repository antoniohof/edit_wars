<template>
 <client-only>
    <a-scene embedded>
      ...
      <a-text font="msdf/cyrilic-msdf.json" opacity="0.2" color="black" font-image="msdf/cyrilic.png" negate="false" v-for="n in news" :key="n.ID" :position="`${n.x} ${n.y} ${n.z}`" :value="n.title_new"></a-text>
    </a-scene>
  </client-only>
</template>
